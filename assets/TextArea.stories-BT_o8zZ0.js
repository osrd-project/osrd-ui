import{r as le,R as e}from"./index-CDs2tPxN.js";import{c as q}from"./index-DX8y_bUt.js";import{F as pe}from"./FieldWrapper-BNxgbzXe.js";import{u as ie}from"./useFocusByTab-Bv_kQF86.js";/* empty css              */import"./index.esm-DT8E0T4M.js";import"./InputStatusIcon-CvRLOZHk.js";const de=40,X=({id:r,label:Z,value:$,hint:L,required:ee,disabled:x,statusWithMessage:s,maxLength:a,onChange:h,onKeyUp:se,onBlur:ae,...re})=>{const[t,te]=le.useState($),T=(t==null?void 0:t.length)||0,{handleKeyUp:oe,handleBlur:ne,isFocusByTab:ce}=ie({onBlur:ae,onKeyUp:se}),ue=A=>{te(A.target.value),h==null||h(A)};return e.createElement(pe,{id:r,label:Z,hint:L,statusWithMessage:s,disabled:x,required:ee,className:"text-area-field-wrapper"},e.createElement("div",{className:q("text-area-wrapper",{"focused-by-tab":ce})},a&&e.createElement("div",{className:q("char-count",{error:T===a,warning:a-T<=de})},T,"/",a),e.createElement("textarea",{className:q("text-area",{[(s==null?void 0:s.status)||""]:!!s}),id:r,value:t,disabled:x,maxLength:a,onChange:ue,onBlur:ne,onKeyUp:oe,...re})))};X.__docgenInfo={description:"",methods:[],displayName:"TextArea"};const fe={component:X,args:{disabled:!1,readOnly:!1,label:"Description"},decorators:[r=>e.createElement("div",{style:{maxWidth:"25rem"}},e.createElement(r,null))],title:"TextArea",tags:["autodocs"]},o={args:{value:"The light you see is this end of the tunnel."}},n={args:{hint:"Be precise and succinct"}},c={args:{maxLength:220}},u={args:{required:!0}},l={args:{value:"A good looking red train.",statusWithMessage:{status:"success"}}},p={args:{statusWithMessage:{status:"info",message:"You won’t be able to change it"}}},i={args:{value:"Blah blah blah",statusWithMessage:{status:"warning",message:"Please make it useful"}}},d={args:{value:"Blah blah blah",statusWithMessage:{status:"warning"}}},m={args:{value:"^pcds^qpdc^plsqd ^cpl qs^dpcl ^`pqsld c^`pl q",statusWithMessage:{status:"error",message:"This doesn’t make sense"}}},g={args:{value:"^pcds^qpdc^plsqd ^cpl qs^dpcl ^`pqsld c^`pl q",statusWithMessage:{status:"error"}}};var f,b,v;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
...
}`,...(H=(N=l.parameters)==null?void 0:N.docs)==null?void 0:H.source}}};var O,F,C;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  args: {
    statusWithMessage: {
      status: 'info',
...
}`,...(C=(F=p.parameters)==null?void 0:F.docs)==null?void 0:C.source}}};var I,U,V;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
